        ...
        <div className='aboutArea'>
            <div className='about'>
                <p>
                    ...
                    I decided I wanted to take on my next challenge, web development. Through web development, I am able to create designs that incorporate my interests and creativity.
